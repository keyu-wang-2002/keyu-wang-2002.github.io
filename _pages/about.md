...
I am passionate about the intuitions from empirical observations and about uncovering the principles behind them, especially <font color='FireBrick'><strong>how intelligence learns</strong></font> -- on what data, at what scale, stepping by what rule, and how early choices set the ceiling on performance like compositional generalization and lifelong learning. My current research centers on <font color='FireBrick'><strong>scalable and efficient foundation models</strong></font>, with a focus on understanding their architectures, optimizers, <font color='FireBrick'><strong>training dynamics</strong></font>, data valuation, reasoning capabilities, and theory.
...
<ul>
  ...
  <li>
    ...
    <strong>Master's Intern & Assistant</strong>: foundation model architectures & pre-training, model compression
  </li>
