...
- <strong>Optimization: </strong> How to effectively and efficiently optimize deep models? How does changing a low-dimensional weights' subspace allow a pre-trained model to adapt to downstream tasks, will this make the model lose safety and trustworthiness behaviours? 
