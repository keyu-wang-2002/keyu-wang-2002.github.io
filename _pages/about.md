...
I am passionate about the intuitions from empirical observations and about uncovering the principles behind them, especially <font color='FireBrick'><strong>how intelligence learn</strong></font> -- on what data, at what scale, stepping by what rule, and how early choices set the ceiling on performance like efficiency,  reasoning, generalization and lifelong learning. My current research centers on <font color='FireBrick'><strong>scalable and efficient foundation models</strong></font>, with a focus on understanding their architectures, training dynamics, data valuation, reasoning capabilities, and theory.
