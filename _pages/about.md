...
- <strong>Optimization: </strong>  How to stably optimize deep models in low-bits? How to effectively reduce the redundancy in the representation learning? How does learning in a low-dimensional weights' subspace allow a pre-trained model to adapt to downstream tasks?
...
- <strong>Benchmarking: </strong> Do current task performance really capture how models behave, not just how they score and rank? How can we validate the faithfulness of intermediate reasoning steps, rather than just exact match and pass@k?
...
- *2025.03 - Present*, **WEI Lab, Max Planck Institute for Intelligence Systems & ELLIS Tuebingen**. Supervisor: Dr. Shiwei Liu
