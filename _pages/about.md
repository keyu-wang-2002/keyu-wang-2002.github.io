...
- <strong>Reasoning: </strong> Why do LLMs have reasoning capabilities?  How to calibrate uncertainty over intermediate reasoning states? What limits inference efficiency, and how to do more with less I/O without sacrifacing reliability?
- <strong>Optimization: </strong> How to stably optimize deep models in low-bits? How does learning in a low-dimensional weights' subspace allow a pre-trained model to adapt to downstream tasks, and will this make the model lose trustworthiness behaviours? 
- <strong>Benchmarking: </strong> Do current task performance really capture how models behave, not just how they score and rank? How can we validate the trustworthiness of intermediate reasoning steps, rather than just exact match and pass@k?
...
I am seeking PhD oppotunities in 27 Spring/Fall! Please feel free to reach out to me via email at​ ​**keyu.wang@student.uni-tuebingen.de**.
