...
- <strong>Reasoning with Accessibility: </strong> Why do LLMs have reasoning capabilities?  How to capture uncertainty over intermediate reasoning states? What limits inference efficiency, and how to do more with less I/O without sacrifacing reliability?
- <strong>Optimization at Scale: </strong> How to effectively and efficiently optimize deep models? How does changing a low-dimensional weights' subspace allow a pre-trained model to adapt to downstream tasks, and will this make the model lose safety behaviours? 
