...
Hi, I'm Keyu, a first-year master student in Machine Learning at [University of Tuebingen]([[https://uni-tuebingen.de/en/]]). Currently, I’m working with [Dr. Shiwei Liu](https://shiweiliuiiiiiii.github.io) on deep compression of LLMs. I earned my B.Eng. in Artificial Intelligence from [Southeast University](https://www.seu.edu.cn/) where I was fortunate to be advised by [Prof. Guilin Qi](https://scholar.google.com/citations?user=1gw3LJQAAAAJ&hl=zh-CN). I also  had a wonderful time at [SEU-131AIClub](https://github.com/131AIClub), witnessing and contributing to its growth from founding to flourishing.

Currently, my research interests cover <font color='FireBrick'><strong>Large Language Models, Machine Learning Systems, Reasoning, AI Efficiency and Trustworthy</strong></font>.  Particularly, I am keen on understanding how LLMs perform reasoning and eliciting its efficiency and effectiveness, e.g., by <font color='FireBrick'><strong> test-time scaling and post-training </strong></font>. During undergraduate research, I focused on  <font color='FireBrick'><strong>neuro-symbolic knowledge representation and reasoning</strong></font>, especially, reasoning[[EMNLP 2024]](https://aclanthology.org/2024.findings-emnlp.141/)[[IJCKG 2023]](https://arxiv.org/abs/2304.01664) and embedding[[DI 2024]](https://arxiv.org/abs/2402.01677) with knowledge graphs and description logic ontologies. 

I am open to research collaborations as well as internship or visiting opportunities. You can find my CV [here](https://github.com/keyu-wang-2002/keyu-wang-2002.github.io/blob/master/docs/Keyu_CV_July_2025.pdf) and please feel free to reach out to me via email at​ ​**keyu.wang@student.uni-tuebingen.de**.
...
**EMNLP 2024 Findings**  [[PDF]](https://aclanthology.org/2024.findings-emnlp.141.pdf) [[Supplementary]](https://aclanthology.org/2024.findings-emnlp.141/)
</div>

<br>

# Misc
- My Chinese name is 汪可予 (Wang Ke Yu). I come from Tongling, Anhui — a small city by the Yangtze River.
...
- I enjoy animations, movies and music. I am a big fan of various chess, board and card games. My favorite games are Texas Hold'em Poker and "Jun Qi" (Chinese Military Chess). 
