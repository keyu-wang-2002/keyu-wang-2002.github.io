...
I am passionate about the intuitions from empirical observations and about uncovering the principles behind them, especially <font color='FireBrick'><strong>how intelligence learns</strong></font> -- on what data, at what scale, stepping by what rule, and how early choices set the ceiling on foundamental capabilities like generalization and lifelong learning. My current interests centers on <font color='FireBrick'><strong>scalable and efficient foundation models</strong></font>, with a focus on understanding their data valuation, architectures, optimizers, <font color='FireBrick'><strong>training dynamics</strong></font>, reliable developing signals, science of scaling,  <font color='FireBrick'><strong>training systems</strong></font>, and theory.
...
#### I. Learning: Model & Optimization, Data, Systems
